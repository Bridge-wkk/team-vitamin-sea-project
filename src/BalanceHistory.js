...
const MOCK_TRANSACTIONS = [
    { id: 1, senderId: "1", senderName: "自分", receiverId: "2", receiverName: "Bさん", amount: 1000, date: "2026/02/04 14:00:00", type: "transfer" },
    { id: 2, senderId: "1", senderName: "自分", receiverId: "3", receiverName: "Cさん", amount: 500, date: "2026/02/04 10:00:00", type: "transfer" },
    { id: 3, senderId: "4", senderName: "Dさん", receiverId: "1", receiverName: "自分", amount: 5000, date: "2026/02/03 18:00:00", type: "transfer" },
    { id: 4, senderId: "1", senderName: "自分", receiverId: "2", receiverName: "Bさん", amount: 2000, date: "2026/02/01 12:00:00", type: "transfer" },
    { id: 5, senderId: "5", senderName: "Eさん", receiverId: "1", receiverName: "自分", amount: 10000, date: "2026/01/20 09:00:00", type: "transfer" },
];
        ...
        <div style={{ backgroundColor: "#f9f9f9", minHeight: "100vh", fontFamily: "sans-serif" }}>
            ...
            <div style={{ padding: "20px" }}>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={allDailyData} margin={{ top: 40, right: 10, bottom: 10, left: 10 }}>
                                ...
                                <Line
                                    ...
                                    strokeWidth={3}
                                    dot={{ r: 0 }}
                                    activeDot={{ r: 6, fill: "#007bff", stroke: "#fff", strokeWidth: 2 }}
                ...
                <div style={{ marginBottom: "20px", backgroundColor: "#fff", padding: "15px", borderRadius: "8px" }}>
                    ...
                    <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "10px" }}>
                        <button
                            ...
                            style={{
                                padding: "6px 12px", borderRadius: "20px", border: "none", cursor: "pointer", fontSize: "12px",
                                backgroundColor: filterType === "all" ? "#333" : "#eee",
                        ...
                        <button
                            onClick={() => { setFilterType("1month"); setStartDate(""); setEndDate(""); }}
                            style={{
                                padding: "6px 12px", borderRadius: "20px", border: "none", cursor: "pointer", fontSize: "12px",
                                backgroundColor: filterType === "1month" ? "#333" : "#eee",
                                color: filterType === "1month" ? "#fff" : "#333"
                            }}
                        >
                            直近1ヶ月
                        </button>
                        <button
                            ...
                            style={{
                                padding: "6px 12px", borderRadius: "20px", border: "none", cursor: "pointer", fontSize: "12px",
                                backgroundColor: filterType === "custom" ? "#333" : "#eee",
                ...
                {filteredList.length === 0 ? (
                    <p style={{ textAlign: "center", color: "#999", marginTop: "30px", fontSize: "12px" }}>
                        該当する明細はありません
                    </p>
                ) : (
                    filteredList.map((dayData) => (
                        <div key={dayData.dateKey} style={{ marginBottom: "15px" }}>
                            {/* 日付ヘッダー */}
                            <div style={{
                                fontSize: "12px", color: "#888", marginBottom: "5px",
                                ...
                                {/* 日計 */}
                                <span>日計:
                                    <span style={{ color: dayData.totalDiff < 0 ? "#D11C1C" : "#28a745", fontWeight: "bold", marginLeft: "4px", fontSize: "13px" }}>
                                        {dayData.totalDiff > 0 ? "+" : ""}{dayData.totalDiff.toLocaleString()}
                                    </span>
                                    <span style={{ color: "#333", fontSize: "11px", fontWeight: "normal", marginLeft: "1px" }}>円</span>
                                </span>
                            </div>
                            ...
                            {dayData.transactions.map((tx) => (
                                <div key={tx.id} style={{
                                    backgroundColor: "#fff", borderRadius: "8px", padding: "12px", marginBottom: "8px",
                                    ...
                                    <div style={{ textAlign: "right" }}>
                                        {/* 個別の金額 */}
                                        <div style={{ fontSize: "14px", fontWeight: "bold", color: tx.isPayment ? "#D11C1C" : "#28a745" }}>
                                            {tx.isPayment ? "-" : "+"}{tx.amount.toLocaleString()}
                                            <span style={{ color: "#333", fontSize: "12px", marginLeft: "2px", fontWeight: "normal" }}>円</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
